pageextension 70829583 PPHRDS_PurchaseInvoiceSubform extends "Purch. Invoice Subform"
{
    actions
    {
        addfirst("F&unctions")
        {
            action(PPHRDS_GetRequestLines)
            {
                ...
                begin
                    ...
                    GetRequestLines.SetRecords(PurchaseHeader, RequestPurchDocType::Invoice);
